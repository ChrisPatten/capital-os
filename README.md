...
- Capital posture tooling is implemented (`compute_capital_posture`) and under sprint review.
- Epic 2+ roadmap work (simulation, debt analysis, approval-gated writes, CI hardening) remains in backlog.
