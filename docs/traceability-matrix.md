...
As of 2026-02-16. Source requirements: `initial_prd.md`.
...
1. Add full reference-dataset performance gate for SC-07 / NFR-03.
2. Add branch coverage threshold enforcement for NFR-07.
