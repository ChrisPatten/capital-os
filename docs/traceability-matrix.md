...
| SC-02 | Deterministic hash-stable outputs | `src/capital_os/observability/hashing.py`, `src/capital_os/tools/*.py` | `tests/replay/test_output_replay.py`, `tests/unit/test_hashing.py` | Covered | Seeded replay checks include posture/simulate/debt/approval.
